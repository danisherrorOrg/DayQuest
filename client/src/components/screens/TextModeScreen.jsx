  ...
  return (
    <div className="screen active">
      <div className="panel">
        ...
        />
        <div style={{ height: 12 }} />
        <button className="primaryBtn" disabled={text.trim().length === 0} onClick={() => onBuild(text)}>
          Build My Level
        </button>
        <p className="sub" style={{ marginTop: 10 }}>
          No timestamps? That's fine too — just describe your day in plain English and I'll pull out the activities.
        </p>
      </div>
    </div>
  );
